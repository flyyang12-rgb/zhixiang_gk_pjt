...
<template>
  <div class="recommend-page">
    ...
    <template v-else-if="result">
      ...
      <template v-else>
        <div class="risk-tabs"><button v-for="risk in ['全部', '冲', '稳', '保']" :key="risk" :class="{ active: activeRisk === risk }" @click="activeRisk = risk as typeof activeRisk">{{ risk }}</button><span>基于 {{ result.sourceYear }} 投档数据 · {{ result.candidates.length }} 所</span></div>
