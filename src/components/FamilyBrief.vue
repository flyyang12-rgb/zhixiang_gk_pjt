...
import { updateDashboardItemNote, type ProfileSummary, type SavedItem, type SchoolDetail } from '../api'

const props=defineProps<{profileId:string;profileSummary:ProfileSummary;details:SchoolDetail[];savedItems:SavedItem[]}>()
